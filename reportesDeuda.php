...
function Header()
{
	...
	$this->Cell(60);
    $this->Cell(70,10,utf8_decode('Información de los apartamentos con su deuda'),0,0,'C');
...
$consulta = "SELECT * FROM apartamentos WHERE Deuda > 0";
...
while($row = $resultado->fetch_assoc()){
	...
	$pdf->Cell(50, 10, $row['NombreDueno'],1, 0, 'C', $alternal);
	$pdf->Cell(50, 10, $row['ApellidoDueno'],1, 0, 'C', $alternal);
	$pdf->Cell(40, 10, ROUND($row['Deuda'],2),1, 1, 'C', $alternal);
		$alternal = !$alternal;
